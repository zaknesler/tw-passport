...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    revoke: function revoke(token) {
      axios["delete"]('/oauth/tokens/' + token.id).then(this.getTokens());
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    prepareComponent: function prepareComponent() {
      this.getClients(); // $('#modal-create-client').on('shown.bs.modal', () => {
    ...
    hideCreateClientForm: function hideCreateClientForm() {
      this.$refs.createClientModal.classList.add('hidden');
    },
    showEditClientForm: function showEditClientForm() {
      this.$refs.editClientModal.classList.remove('hidden');
    },
    hideEditClientForm: function hideEditClientForm() {
      this.$refs.editClientModal.classList.add('hidden');
    },
    store: function store() {
      this.persistClient('post', '/oauth/clients', this.createForm, this.$refs.createClientModal);
    },
    ...
    update: function update() {
      this.persistClient('put', '/oauth/clients/' + this.editForm.id, this.editForm, this.$refs.editClientModal);
    },
...
var render = function() {
  ...
  return _c("div", { staticClass: "border rounded-lg" }, [
    _c(
      "div",
      {
        staticClass:
          "px-4 py-3 border-b bg-gray-100 text-gray-600 font-semibold rounded-t-lg"
      },
    ...
    _c(
      "div",
      {
        staticClass: "p-4 bg-white text-gray-700 rounded-b-lg overflow-hidden"
      },
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "z-10" }, [_vm._t("default")], 2),
      _vm._v(" "),
      _c("div", {
        staticClass:
          "z-0 absolute top-0 left-0 w-full h-full bg-black opacity-10"
      })
    ]
  )
}
    ...
    [
      _c("div", { staticClass: "border rounded-lg" }, [
        _c(
          ...
          {
            staticClass:
              "px-4 py-3 border-b bg-gray-100 text-gray-600 rounded-t-lg flex items-center justify-between"
          },
          [
            ...
            _c(
              "a",
              {
                staticClass: "text-sm cursor-pointer hover:underline",
                attrs: { tabindex: "-1" },
                on: {
                  click: function($event) {
                    $event.preventDefault()
                    _vm.createForm.visible = true
                  }
                }
              },
        ...
        _c(
          ...
          {
            staticClass:
              "p-4 bg-white text-gray-700 rounded-b-lg overflow-hidden"
          },
          [
      ...
      _c(
        "modal",
        {
          ...
          attrs: { visible: _vm.createForm.visible }
        },
        [
          _c(
            "div",
            { staticClass: "border border-gray-400 bg-white rounded-lg" },
            [
              _c(
                "div",
                {
                  staticClass:
                    "p-4 border-b bg-gray-100 rounded-t-lg flex items-center justify-between"
                },
                [
                  _c("h4", { staticClass: "text-gray-600 font-semibold" }, [
                    _vm._v("Create Client")
                  ]),
                  _vm._v(" "),
                  _c(
                    "button",
                    {
                      staticClass: "p-1 text-gray-600 hover:text-gray-900",
                      attrs: { "aria-hidden": "true" },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          _vm.createForm.visible = false
                        }
                      }
                    },
                    [
              ...
              _c("div", { staticClass: "p-6" }, [
                ...
                _c("form", { attrs: { role: "form" } }, [
                  _c("div", [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "mt-2 text-gray-600 text-sm" }, [
...
/* harmony import */ var _components_passport_Clients_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/passport/Clients.vue */ "./resources/js/components/passport/Clients.vue");
/* harmony import */ var _components_passport_AuthorizedClients_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/passport/AuthorizedClients.vue */ "./resources/js/components/passport/AuthorizedClients.vue");
/* harmony import */ var _components_passport_PersonalAccessTokens_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/passport/PersonalAccessTokens.vue */ "./resources/js/components/passport/PersonalAccessTokens.vue");
...
Vue.component('modal', _components_Modal_vue__WEBPACK_IMPORTED_MODULE_1__["default"]);
Vue.component('example-component', _components_ExampleComponent_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
Vue.component('passport-clients', _components_passport_Clients_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
Vue.component('passport-authorized-clients', _components_passport_AuthorizedClients_vue__WEBPACK_IMPORTED_MODULE_4__["default"]);
Vue.component('passport-personal-access-tokens', _components_passport_PersonalAccessTokens_vue__WEBPACK_IMPORTED_MODULE_5__["default"]);
var app = new Vue({
  el: '#app',
  data: {
...
__webpack_require__(/*! /Users/zak/Code/Valet/Laravel/passport/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/zak/Code/Valet/Laravel/passport/resources/less/app.less */"./resources/less/app.less");
